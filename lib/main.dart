...
class _ContactPageState extends State<ContactPage> {
  List<Contact> allContacts = [
    Contact(name: "Lutfiah Nabila", phone: "0812-8876-1234", status: "Online"),
    Contact(name: "Roihan Bagus", phone: "0813-9987-4412", status: "Offline"),
    Contact(name: "Ananda Shavira", phone: "0819-3321-0098", status: "Away"),
    Contact(name: "Cesilia Rosa", phone: "0815-5555-6666", status: "Online"),
    Contact(name: "Yoga Priyo", phone: "0822-1111-2222", status: "Offline"),
    Contact(name: "Ryo Arisky", phone: "0878-3333-4444", status: "Away"),
  ];
  ...
  // New Method to toggle the theme mode
                          ...
                          child: ListTile(
                            ...
                            leading: Stack(
                              children: [
                                // Avatar Icon Orang
                                CircleAvatar(
                                  radius: 28, // Setengah dari 56 (width/height sebelumnya)
                                  backgroundColor: getAvatarColor(index),
                                  child: const Icon(
                                    Icons.person_rounded, // Ikon Orang
                                    color: Colors.white,
                                    size: 30,
                                  ),
                                ),
